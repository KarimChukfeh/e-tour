 ...
 * - Implementation: TicTacInstance (deployed in constructor)
 * - Raffle thresholds specific to TicTacChain (lower = more accessible)
 *
 * Usage:
 * 1. Deploy shared modules (ETourInstance_Core, ETourInstance_Matches,
 *    ETourInstance_Prizes, ETourInstance_Escalation)
 * 2. Deploy TicTacChainFactory(moduleCore, moduleMatches, modulePrizes, moduleEscalation)
...
contract TicTacChainFactory is ETourFactory {
    ...
    constructor(
        ...
        address(new TicTacInstance()),  // deploy implementation inline
        moduleCore,
        moduleMatches,
        modulePrizes,
        moduleEscalation
